...
<div class="container mt-2">
            ...
            <div class="col-md-6">
               <div class="row">
                <div class="col-md-5">
                 ...
                 <div class="col-md-6">
                     <input type="text" name="token" class="border border-outline border-primary" style="border-radius: 7px;">
   ...
   <div class="row mt-4">
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-5">
                <h5 style="color:rgb(34, 190, 241)" class="pl-3 ml-2 pt-4">Receive Address</h5>
            </div>
            <div class="col-md-6">
            <textarea name="receive_addr" id="" cols="40" rows="5" class="border border-outline border-primary" style="border-radius: 7px;"></textarea>
            </div>
    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-5">
                ...
                <h5 style="color:rgb(34, 190, 241)" class="pl-3 ml-2 pt-4">Dropoff Address</h5>
            </div>
            <div class="col-md-6">
            <textarea name="drop_addr" id="" cols="40" rows="5" class="border border-outline border-primary" style="border-radius: 7px;"></textarea>
            </div>
        </div>
