    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <div class="logo">
                    <img src="{{asset('assets/img/bahosi.png')}}" width="40" height="40" alt=""> <span>HS Cargo Services</span>
                </div>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a href="{{route('wayplanlist')}}"><i class="bluecolor fas fa-cube mr-1"></i>Wayplan Lists<i class="float-right  bluecolor fas fa-angle-right"></i></a></li>

                                <li><a href="#"><i class="bluecolor fas fa-cube mr-1"></i> Reject Way<i class="float-right  bluecolor fas fa-angle-right"></i></a></li>
                            </ul>
                        </li>
