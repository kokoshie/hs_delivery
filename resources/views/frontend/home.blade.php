 ...
 {{-- <span>#4568DC</span> --}}
      <div class="container">
        <div class="row flex-center">
          <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="{{asset('frontend/assets/img/pic1.jpg')}}" alt=""/></div>
          <div class="col-md-7 col-lg-6 mt-5 text-md-start">
            ...
            <p class="mt-2 mb-4" style="font-style:italic;color:black">
