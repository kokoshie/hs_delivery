      ...
      <div class="container"><a class="navbar-brand" href="#"><img src="{{asset('frontend/assets/img/logo10.jpg')}}" alt="" width="200"/><span class="text-1000 fs-1 ms-2 fw-medium"></span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {{-- <form class="d-flex py-3 py-lg-0"> --}}
            ...
            {{-- <a href="" class="btn outline rounded-pill order-0" data-toggle="modal" data-target="#track">Track</a> --}}

            <a href="{{route('search_track')}}" class="btn outline rounded-pill order-0">Track</a>
