                ...
                htmlcard += ` <div class="card order ">
                        ...
                        <div class="total mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4"><span class="border border-primary px-1" id="now">${v.myawady_date}</span></div>
                            </div>
                        </div>
                        <div class="pricing">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4"><span class="border border-primary px-1" id="now">${v.dropoff_date}</span></div>
                            </div>
                        </div>
                        <div class="total">
                ...
                htmldt += `<div class="card order ">
                        ...
                        <div class="total mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3"><span class="border border-primary px-1" id="now">Myawaddy</span></div>
                                <div class="col-4"><span class="border border-primary px-1" id="now">${mya_status}</span></div>
                                <div class="col-4"><span class="border border-primary px-1" id="now">${data.myawady_date}</span></div>
                            </div>
                        </div>
                        <div class="pricing">
                            <strong id="name">Dropoff Point</strong>
                            <div class="row">
                                ...
                                <div class="col-3"><span class="border border-primary px-1" id="now">${drop_point}</span></div>
                                <div class="col-4"><span class="border border-primary px-1" id="now">${drop_status}</span></div>
                                <div class="col-4"><span class="border border-primary px-1" id="now">${data.dropoff_date}</span></div>
                            </div>
                        </div>
                        <div class="total">
